...
public class Matrix4d {
    ...
    public final Vector3f multiply(Vector3f var) {
        float var1 = this.matrix[0][0] * var.x + this.matrix[0][1] * var.y + this.matrix[0][2] * var.z + this.matrix[0][3] * 1;
        float var2 = this.matrix[1][0] * var.x + this.matrix[1][1] * var.y + this.matrix[1][2] * var.z + this.matrix[1][3] * 1;
        float var3 = this.matrix[2][0] * var.x + this.matrix[2][1] * var.y + this.matrix[2][2] * var.z + this.matrix[2][3] * 1;
